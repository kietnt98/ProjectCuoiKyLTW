		...
		<div class="content">
			<div id="menu">
 				<ul class="nav nav-tabs" id="navmenu">
 					<li><a data-toggle="tab" href="#Detail">Chi tiết đề</a></li>
 					<li><a data-toggle="tab" href="#Add">Thêm đề</a></li>
 					<li><a data-toggle="tab" href="#Edit"> Sửa đề</a></li>
 					<li><a data-toggle="tab"href="#Delete">Xoá đề</a></li>
						 ...
						 <c:forEach var="listTest" items="${listtest}">
               				 <tr>
                    			 ...
                    			 <td><c:out value="${listTest.timeend}" /></td>
                   				 ...
                   				 <td><c:out value="${listTest.testtypename}" /></td>
                   				 <td><c:out value="${listTest.subjectname}" /></td>
                   				 <td><a href="DetailTestController?test_id=<c:out value='${listTest.testid}' /> ">Chi tiết</a></td>
                			</tr>
           				 </c:forEach>
					</table>
					<br/>
