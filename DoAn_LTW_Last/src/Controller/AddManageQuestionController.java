...
/**
 * Servlet implementation class AddManageQuestionController
 */
@WebServlet("/AddManageQuestionController")
public class AddManageQuestionController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddManageQuestionController() {
        super();
