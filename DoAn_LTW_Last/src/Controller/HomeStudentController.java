...
import DAO.ListTestOfStudentDAO;
...
public class HomeStudentController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(""+user );
		 List<Test> listtest = ListTestOfStudentDAO.ListTestSV(user);
			
	        request.setAttribute("listtest", listtest);
	        RequestDispatcher dispatcher = request.getRequestDispatcher("View/HomeStudent.jsp");
